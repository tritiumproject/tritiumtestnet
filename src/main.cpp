...
uint256 hashGenesisBlock("0x00000a01dc23c6aac595fe20510150809b0f7b29f7f20c0c91925e447061d4e7");//hgb
...
static const int64 nTargetSpacing = 2 * 60; // 30 seconds
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "TritiumTestnetTimestamp";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xc4a7bf8c6f3008da7b66987e4a9c4435eca1382b87dd1d455ccef61a4be11770"));
        //merklerootentry
        block.print();
